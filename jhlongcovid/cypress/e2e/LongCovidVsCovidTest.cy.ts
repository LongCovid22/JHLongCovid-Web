...
function End(skipQuestionUntil: number, longCovidAnswer: string) {
...
function RadioOnlyParseAndNextWithSkipQuestion( answer: string, answerConditional: string[], newSkipQuestionUntilConditional: number) {
...
function CovidLongCovidCustom(covid: string, longCovidAnswer: string, recoveryCovid: string, lastPositive: string, recoveryDays: string) {
  skipQuestionUntil = 0;
  Start();
  ...
  RadioOnlyParseAndNextWithSkipQuestion(covid, ["No"], 14);
  }
  ...
  if (3 >= skipQuestionUntil) {
    RadioOnlyParseAndNextWithSkipQuestion("No", ["No"], 5);
  }
  ...
  if (5 >= skipQuestionUntil) {
    TextInputandParseAndNext("Enter date", lastPositive);
  }

  console.log(skipQuestionUntil);
  ...
  if (8 >= skipQuestionUntil) {
    ...
    //   }
    // }
    RadioOnlyParseAndNextWithSkipQuestion("No", ["No"], 10);
  }
  ...
  if (10 >= skipQuestionUntil) {
    ...
    //   }
    // }
    RadioOnlyParseAndNextWithSkipQuestion("Do not know", ["No", "Do not know"], 12);
  }
  ...
  if (12 >= skipQuestionUntil) {
    ...
    //   }
    // }
    RadioOnlyParseAndNextWithSkipQuestion(recoveryCovid, ["No"], 14);
  }
  if (13 >= skipQuestionUntil) {
    ...
    // },
    // "Branching": null
    TextInputandParseAndNext("Enter number of days", recoveryDays);
  }
  if (14 >= skipQuestionUntil) {
    ...
    //   }
    // }
    RadioOnlyParseAndNextWithSkipQuestion("No", ["No"], 18);
  }
  ...
  End(18, longCovidAnswer);
}
describe("Not Recovered", () => {
  beforeEach(() => {
    // Assuming your application is running at http://localhost:3001
    cy.visit("http://localhost:3001");
  });
  it("Time Past < 4 weeks and no self reported  Long Covid", () => {
    CovidLongCovidCustom("Yes", "No", "No", "2023-03-29", ""); //No Long Covid
  });
  it("Time Past < 4 weeks and yes self reported  Long Covid", () => {
    CovidLongCovidCustom("Yes", "Yes", "No", "2023-03-29", ""); //Yes Long Covid
  });

  it("Time Past > 4 weeks and no self reported  Long Covid", () => {
    CovidLongCovidCustom("Yes", "No", "No", "2023-11-27", ""); //Yes Long Covid
  });
  it("Time Past > 4 weeks and yes Long Covid", () => {
    CovidLongCovidCustom("Yes", "Yes", "No", "2023-11-27", ""); //Yes Long Covid
  });
});
describe("Covid Recovered", () => {
  beforeEach(() => {
    // Assuming your application is running at http://localhost:3001
    cy.visit("http://localhost:3001");
  });
  it("Time Recovered < 4 weeks and no self reported Long Covid", () => {
    CovidLongCovidCustom("Yes", "No", "Yes", "2023-03-29", "3"); // No Long Covid
  });
  it("Time Recovered < 4 weeks and yes self reported  Long Covid", () => {
    CovidLongCovidCustom("Yes", "Yes", "Yes", "2023-03-29", "3"); // Yes Long Covid
  });
  it("Time Recovered > 4 weeks and no self reported  Long Covid", () => {
    CovidLongCovidCustom("Yes", "No", "Yes", "2023-11-27", "45"); // Yes Long Covid
  });
  it("Time Recovered > 4 weeks and yes self reported Long Covid", () => {
    CovidLongCovidCustom("Yes", "Yes", "Yes", "2023-11-27", "45"); // Yes Long Covid
  });
});



// describe("Test Long Covid Conditions", () => {
//   beforeEach(() => {
//     // Assuming your application is running at http://localhost:3001
//     cy.visit("http://localhost:3001");
//   });

//   it("No Covid, No Self Reported Long Covid", () => {
//     CovidLongCovidCustom("No", "No", "", "", "");
//   });

//   it("No Covid, Yes Self Reported Long Covid", () => {
//     CovidLongCovidCustom("No", "Yes", "", "", "");
//   })
// });
