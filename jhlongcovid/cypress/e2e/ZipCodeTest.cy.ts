...
function testZipcode(zipcode: string) {
  ...
  BeingSurveyTest();
  ConsentParseAndNext("nnew83848@gmail.com");
  DemographicsParseAndNext("16", "Male", "6", "3", "150", "White", zipcode);
...
describe("Test Different Zipcodes in the US", () => {
  beforeEach(() => {
...
//   it("Santa Fe, New Mexico", () => {
//     testZipcode("87501");
// });

// it("Baton Rouge, Louisiana", () => {
//     testZipcode("70801");
// });

// it("Charleston, West Virginia", () => {
//     testZipcode("25301");
// });

// it("Burlington, Vermont", () => {
//     testZipcode("05401");
// });
...
it("Fargo, North Dakota", () => {
    testZipcode("58102");
});

it("Rapid City, South Dakota", () => {
    testZipcode("57701");
});
...
describe("Test Different Zipcodes within same state, Texas", () => {
  beforeEach(() => {
    // Assuming your application is running at http://localhost:3001
    cy.visit("http://localhost:3001");
  });
