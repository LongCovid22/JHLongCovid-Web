import { BeingSurveyTest, ConsentParseAndNext, DemographicsParseAndNext
  ...
  let answer = {
    ...
    answers : [
      ...
      {
        questionNum: "7",
        question: "When do you know or think you had your most recent COVID-19 infection?",
        answerType: "date",
        answer: "11/2/2023"
  ...
  describe("Iterate through Step 36", () => {
    ...
    it("Should Iterate through the Survey Succesfully", () => {
      ...
      RadioOnlyClick("2 infections (reinfected once)");
      RadioOnlyClick("3 infections (reinfected twice)");
      RadioOnlyClick("Do not know");
      ...
      let currentQuestion: any = surveyLogic.questions[1][1];
      let option = currentQuestion.options[3];
