...
function VaccinationsCustom(vaccinated: string, vaccineDosage: string, vaccineType: string) {
  skipQuestionUntil = 0;
  Start();
  ...
  if (11 >= skipQuestionUntil) {
    ...
    MultiChoiceParseAndNext(["Antiviral pill", "Do not know", "Antibiotics,", "Oral steroids, such a"]);
  ...
  if (14 >= skipQuestionUntil) {
    ...
    //   }
    // }
    RadioOnlyParseAndNextWithSkipQuestion(vaccinated, ["No"], 18);
  }
  if (15 >= skipQuestionUntil) {
    ...
    if (vaccineDosage === "Do not know") {
      ...
      getDataTestIdAndSelectAndNext("dropdown-input", vaccineDosage);
    }
...
describe("Vaccinations Test", () => {
  ...
  it("Yes 1 Dose Pfizer", () => {
    VaccinationsCustom("Yes", "1", "Pfizer"); //No Long Covid
  });

  it("Yes 2 Dose Moderna", () => {
    VaccinationsCustom("Yes", "2", "Moderna"); //No Long Covid
  });

  

  it("Yes 3 Dose Janssen", () => {
    VaccinationsCustom("Yes", "3", "Janssen"); //No Long Covid
  });

  it("Yes 4 Dose Novavax", () => {
    VaccinationsCustom("Yes", "4", "Novavax"); //No Long Covid
  });

  it("Yes 5 Dose Do not know", () => {
    VaccinationsCustom("Yes", "5", "Do not know"); //No Long Covid
  });

  it("Yes 6 Does Experimental Vaccine A", () => {
    VaccinationsCustom("Yes", "6", "Experimental Vaccine A"); //No Long Covid
  });


  it("No", () => {
    VaccinationsCustom("No", "", ""); //No Long Covid
  });

  it("Do not know", () => {
    VaccinationsCustom("Do not know", "",""); //No Long Covid
  });
