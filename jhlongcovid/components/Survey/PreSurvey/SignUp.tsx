...
async function confirmSignUp(username: string, code : string, setShowSurvey :(bool : boolean) => void) {
    try {
...
function sendEmail(emailConfirmed: boolean, setEmailConfirmed : (b : boolean) => void) {
...
export const SignUp: React.FC<SignUpProps> = ({setCurrentPage, setShowSurvey}) => {
    ...
    return (
        <VStack>
            ...
            <Input placeholder="password" onChange = {changePassword} type = "password"></Input>
            <Button onClick = {() => {
