      ...
      <ModalContent borderRadius={20}>
        ...
        <ModalBody>
          <FormControl>
            ...
            These questions will ask you about your exposure to COVID-19. Please
            ...
            <Box p="1" w="80%">
              <FormLabel>
                How many time have you tested positive for COVID-19?
              </FormLabel>
              <Input />
            </Box>
            <Box p="1" w="80%">
              <FormLabel>
                When was the last time you tested positive for COVID-19?
              </FormLabel>
              <Input />
            </Box>
            <Box p="1" w="80%">
              <FormLabel>
                What symptoms did you have at all exposures?
              </FormLabel>
              <Input />
            </Box>
            <Box p="1" w="80%">
              <FormLabel>
                Did you ever require any treatment from a doctor to help you
                breathe, such as supplemental oxygen via a face mask, through
                your nose, or through a breathing tube?
              </FormLabel>
              <Select>
                <option>Yes</option>
                <option>No</option>
            ...
            <Box p="1" w="80%">
              <FormLabel>
                Did you take any antiviral medicines for COVID-19?
              </FormLabel>
              <Select>
                <option>Yes</option>
                <option>No</option>
