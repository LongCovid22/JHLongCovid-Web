        ...
        react_2["default"].createElement(react_1.Menu, null,
            ...
            react_2["default"].createElement(react_1.MenuList, { style: {
                ...
                react_2["default"].createElement(react_1.Box, { className: Header_module_css_1["default"].Image },
                    ...
                    react_2["default"].createElement(react_1.Button, { onClick: onOpen, style: {
                            width: "100%"
                        } },
                        react_2["default"].createElement(react_1.Icon, { as: md_1.MdOutlinePrivacyTip }),
                        "Privacy Statement"),
                    react_2["default"].createElement(react_1.Modal, { isOpen: isOpen, onClose: onClose },
                        ...
                        react_2["default"].createElement(react_1.ModalContent, null,
                            react_2["default"].createElement(react_1.ModalHeader, null, "Modal Title"),
                            ...
                            react_2["default"].createElement(react_1.ModalFooter, null,
                                react_2["default"].createElement(react_1.Button, { colorScheme: 'blue', mr: 3, onClick: onClose }, "Close"),
                                react_2["default"].createElement(react_1.Button, { variant: 'ghost' }, "Secondary Action")))),
                    react_2["default"].createElement(react_1.Button, { onClick: onOpen, style: {
                            width: "100%"
                        } },
                        react_2["default"].createElement(react_1.Icon, { as: im_1.ImNewspaper }),
                        "Legal Statement"),
                    react_2["default"].createElement(react_1.Modal, { isOpen: isOpen, onClose: onClose },
                        react_2["default"].createElement(react_1.ModalOverlay, null),
                        react_2["default"].createElement(react_1.ModalContent, null,
                    ...
                    react_2["default"].createElement(react_1.Button, { onClick: onOpen, style: {
                        ...
                        react_2["default"].createElement(react_1.Icon, { as: md_1.MdChecklist }),
                        "Terms of Service"),
                    react_2["default"].createElement(react_1.Modal, { isOpen: isOpen, onClose: onClose },
                        react_2["default"].createElement(react_1.ModalOverlay, null),
                        react_2["default"].createElement(react_1.ModalContent, null,
