...
exports.Search = function () {
    ...
    return (react_2["default"].createElement(react_1.Flex, { className: Header_module_css_1["default"].leftHeaderStack, align: "center", gap: 3, boxShadow: "xl" },
        react_2["default"].createElement(react_1.Menu, { closeOnBlur: false, closeOnSelect: false },
            ...
            react_2["default"].createElement(react_1.MenuList, { style: {
                ...
                react_2["default"].createElement(react_1.VStack, { spacing: 4, maxWidth: 300 },
                    ...
                    react_2["default"].createElement(react_1.Text, { fontSize: "sm", color: "black" }, "Johns Hopkins experts in global public health, infectious disease, and emergency preparedness have been at the forefront of the international response to COVID-19. Privacy has been at the forefront of our work."),
